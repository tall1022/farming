<%@page import="admin.model.GoodsBean"%>
<%@page import="basket.model.Basket"%>
...
Member memberbean=(Member)request.getAttribute("memberbean");
%>
<h1>주문상세내역</h1>
<table>
...
휴대폰:<br>
이메일주소:<%=memberbean.getM_email() %><br>
<h1>배송지정보</h1>
받는사람:<input type="text" name="o_receive_name" value="<%=memberbean.getM_name()%>"><br>
...
<h1>결제정보</h1>
입금자명(온라인입금일경우):<input type="text" name="o_trade_payer" value="<%=memberbean.getM_name()%>"><br>
