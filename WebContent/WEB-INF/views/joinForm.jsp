...
<table border="1">
	...
	<tr><th>이름</th><td><input type="text" name="name"
		required="required" style="width:400px;height:35px"></td></tr>
	<tr><th>주민등록번호</th><td><input type="text" name="rrn"
		required="required" pattern="\d{6}-\d{7}" style="width:400px;height:35px"></td></tr>
	<!-- <tr><th>성별</th><td><input type="radio" name="sex"
		required="required" pattern="\d{6}-\d{7}" style="width:400px;height:35px"></td></tr> -->
	...
	<tr><th>우편번호</th><td><input type="text" name="zipcode"
		required="required" style="width:400px;height:35px">
